...
<body>
    <div>
        ...
        <section>
            <nav>
                <ul class="ul_sous">
                    <li><a class="presentation" href="presentation_locaux.php">Locaux</a></li>
        ...
        <section class="sec-locaux">
            ...
            <p>Le site se compose de quatre bâtiments, dont deux dotés de quatre étages et donc de 5 niveaux 
                ...
                Les bâtiments A et B datent d'une quinzaine d'années. 
                <img src="images/image_locaux.png" alt="">
            </p>    
            <p>
            ...
            <p>L’autre partie se trouve au premier étage du bâtiment C. Différents locaux de service (archives, stockage local d'entretien ...) se trouvent en sous-sol.
                <img src="images/image_locaux1.png" alt="">
                <img src="images/image_locaux2.png" alt="">
             <p>   
