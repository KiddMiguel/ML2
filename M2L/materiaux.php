        ...
        <section>
            <nav>
                <ul class="ul_sous">
                    ...
                    <li><a class="materiaux" href="materiaux.php">Matériaux</a></li>
                    <li><a href="reservation.php">Reservation de salle</a></li>
                    <li><a href="service.php">Services</a></li>
                </ul>
            </nav>
        </section>
        <section class="sec-materiaux" >
            <div class="div_equipement">
                <h1>Equipements</h1>
                <p>Pour ce qui est des ordinateurs et des outils d'impression, la M2L ne dispose que de ses propres équipements, dans les bureaux d'administration du CROSL et dans la salle multimédia. Les bureaux des ligues sont équipés par les
            ...
            <div class="img_materiaux"><img src="Images/image_materiaux.png" alt=""></div>
            ...
            <div class="img_materiaux">
                <img src="images/image_materiaux2.png" alt="">
            <p>Dans un étage du bâtiment A</p>
        
                <img src="images/image_materiaux3.png" alt="">
                <p> 
            ...
            <h3>Réseaux IP</h3>
            <div class="img_materiaux">
                <img src="images/image_materiaux4.png" alt="">
            </div>
